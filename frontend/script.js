...
function showMainApp() {
  ...
  document.getElementById("main-app").style.display = "flex"; // Crucial: Set main-app to flex
  updateUserInfo();
  showSection("feed", null); // Ensure feed is loaded when the app starts
}
...
function createPostElement(post, isLiked) {
  ...
  postDiv.className = "post-card"; // Changed class from 'post' to 'post-card'
